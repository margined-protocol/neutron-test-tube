use injective_std::types::injective::oracle::v1beta1::{
    MsgRelayPriceFeedPrice, MsgRelayPriceFeedPriceResponse, MsgRelayProviderPrice,
    MsgRelayPythPrices, MsgRelayPythPricesResponse, QueryModuleStateRequest,
    QueryModuleStateResponse, QueryOraclePriceRequest, QueryOraclePriceResponse,
    QueryPythPriceRequest, QueryPythPriceResponse,
};
    ...
    R: Runner<'a>,
{
    ...
    fn_execute! {
        pub relay_provider: MsgRelayProviderPrice => MsgRelayPriceFeedPriceResponse
    }
